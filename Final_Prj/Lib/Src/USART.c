...
static void Config_GPIO_USART(){
	...
	PA2.pGPIOx = GPIOA;
	PA2.GPIO_Pin_Config_t.GPIO_PinNumber = GPIO_PIN_NUM_2;
	PA2.GPIO_Pin_Config_t.GPIO_PinMode = GPIO_MODER_ALTFM;
	PA2.GPIO_Pin_Config_t.GPIO_PinOPType = GPIO_OTYPER_PP;
	PA2.GPIO_Pin_Config_t.GPIO_PinSpeed = GPIO_OSPEEDR_HIGH;
	PA2.GPIO_Pin_Config_t.GPIO_PinPuPdControl = GPIO_PUPDR_NOPUPD;
	PA2.GPIO_Pin_Config_t.GPIO_PinAltFunMode_Low = GPIO_AFRL_AF7;
	GPIO_Init(&PA2);

	// Enable port PB9
	GPIO_Handle_t PA3;	// RX
	PA3.pGPIOx = GPIOA;
	PA3.GPIO_Pin_Config_t.GPIO_PinNumber = GPIO_PIN_NUM_3;
	PA3.GPIO_Pin_Config_t.GPIO_PinMode = GPIO_MODER_ALTFM;
	PA3.GPIO_Pin_Config_t.GPIO_PinOPType = GPIO_OTYPER_PP;
	PA3.GPIO_Pin_Config_t.GPIO_PinSpeed = GPIO_OSPEEDR_HIGH;
	PA3.GPIO_Pin_Config_t.GPIO_PinPuPdControl = GPIO_PUPDR_NOPUPD;
	PA3.GPIO_Pin_Config_t.GPIO_PinAltFunMode_Low = GPIO_AFRL_AF7;
	GPIO_Init(&PA3);
}
